...
final class ActorFixedInvMenuTypeBuilder implements InvMenuTypeBuilder{
	...
	use FixedInvMenuTypeBuilderTrait{ FixedInvMenuTypeBuilderTrait::setSize as parentSetSize; }
	use GraphicNetworkTranslatableInvMenuTypeBuilderTrait{ GraphicNetworkTranslatableInvMenuTypeBuilderTrait::setNetworkWindowType as parentSetNetworkWindowType; }
