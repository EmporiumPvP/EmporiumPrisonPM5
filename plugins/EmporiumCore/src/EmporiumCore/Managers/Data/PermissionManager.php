...
class PermissionManager {
    ...
    public static function setOnlinePlayerDefaultPermissions(Player $player): void {
        ...
        DataManager::setData($player, "Permissions", "emporiumprison.command.playerlevel", true);
        ...
        DataManager::setData($player, "Permissions", "emporiumenchants.command.enchant", false);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.info", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.list", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.remove", false);
        # rank Commands
        ...
        DataManager::setData($player, "Permissions", "emporiumcore.command.ceshop", false);
        DataManager::setData($player, "Permissions", "emporiumprison.command.oreexchanger", false);
        DataManager::setData($player, "Permissions", "emporiumprison.command.blacksmith", false);
        DataManager::setData($player, "Permissions", "emporiumprison.command.wormhole", false);
        # staff Commands
        ...
        # vaults
        DataManager::setData($player, "Permissions", "playervaults.vault.1", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.2", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.3", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.4", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.5", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.6", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.7", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.8", false);
        DataManager::setData($player, "Permissions", "playervaults.vault.9", false);
    }
    ...
    public static function setOfflinePlayerDefaultPermissions($player): void {
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.playerlevel", true);
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.enchant", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.info", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.list", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.remove", false);
        # rank Commands
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumcore.command.ceshop", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.oreexchanger", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.blacksmith", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.wormhole", false);
        # staff Commands
        ...
        # vaults
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.1", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.2", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.3", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.4", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.5", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.6", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.7", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.8", false);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.9", false);
    }
    ...
    public static function setOnlinePlayerStaffPermissions(Player $player, Bool $statement): void {
        ...
        DataManager::setData($player, "Permissions", "emporiumenchants.command.enchant", $statement);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.info", $statement);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.list", $statement);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.remove", $statement);
    }
    ...
    public static function setOfflinePlayerStaffPermissions($player, Bool $statement): void {
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.enchant", $statement);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.info", $statement);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.list", $statement);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.remove", $statement);
    }
    ...
    public static function setOnlinePlayerAllPermissions(Player $player): void {
        ...
        DataManager::setData($player, "Permissions", "emporiumprison.command.mines", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.enchant", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.info", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.list", true);
        DataManager::setData($player, "Permissions", "emporiumenchants.command.remove", true);
        # rank Commands
        ...
        DataManager::setData($player, "Permissions", "emporiumcore.command.ceshop", true);
        DataManager::setData($player, "Permissions", "emporiumprison.command.oreexchanger", true);
        DataManager::setData($player, "Permissions", "emporiumprison.command.blacksmith", true);
        DataManager::setData($player, "Permissions", "emporiumprison.command.wormhole", true);
        # staff Commands
        ...
        # vaults
        DataManager::setData($player, "Permissions", "playervaults.vault.1", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.2", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.3", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.4", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.5", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.6", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.7", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.8", true);
        DataManager::setData($player, "Permissions", "playervaults.vault.9", true);
    }
    ...
    public static function setOfflinePlayerAllPermissions($player): void {
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.enchant", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.info", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.list", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumenchants.command.remove", true);
        # rank Commands
        ...
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumcore.command.sell", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumcore.command.ceshop", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.oreexchanger", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.blacksmith", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "emporiumprison.command.wormhole", true);
        # staff Commands
        ...
        # vaults
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.1", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.2", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.3", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.4", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.5", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.6", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.7", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.8", true);
        DataManager::setOfflinePlayerData($player, "Permissions", "playervaults.vault.9", true);
    }
    ...
    public static function setOnlinePlayerRankPermissions(Player $player, $rank): void {
        ...
        switch($rank) {
            ...
            case "majesty":
                ...
                DataManager::setData($player, "Players", "RankFormat", "§f<§5Imperial§f>");
                break;
