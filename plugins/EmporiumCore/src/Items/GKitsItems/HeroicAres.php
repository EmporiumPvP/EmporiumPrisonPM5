...
class HeroicAres {
    ...
    public function helmet(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::GOLD . "Ares Helmet");
        # get enchants
    ...
    public function chestplate(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::GOLD . "Ares Chestplate");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function leggings(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::GOLD . "Ares Leggings");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function boots(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::GOLD . "Ares Boots");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function sword(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::GOLD . "Ares Sword");
        # get enchants
