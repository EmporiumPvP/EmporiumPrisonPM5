...
class Cyborg {
    ...
    public function helmet(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::DARK_AQUA . "Cybernetic Visor");
        # get enchants
    ...
    public function chestplate(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::DARK_AQUA . "Cybernetic Chestplate");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function leggings(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::DARK_AQUA . "Cybernetic Legs");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function boots(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::DARK_AQUA . "Cybernetic Boots");
        # get enchants
        $enchant1 = Utils::getRandomArmourEnchant();
        $enchant1Level = mt_rand(1, $enchant1->getMaxLevel());
        $enchant2 = Utils::getRandomArmourEnchant();
    ...
    public function sword(): Item {
        ...
        $item->setCustomName(TF::BOLD . TF::DARK_AQUA . "Adamantium Blade");
        # get enchants
