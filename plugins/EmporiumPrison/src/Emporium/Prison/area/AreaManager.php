...
class AreaManager {
    ...
    public function init(): void {
        ...
        $this->addArea(new Area("Spawn",
            ...
            new Position(-1409, 255, -189, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        ...
        $this->addArea(new Area("TutorialMine",
            ...
            new Position(-437, 255, -190, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("TutorialMine"))));

        # mines
        $this->addArea(new Area("CoalMine",
            new Position(-1303, 0, -174, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world")),
            new Position(-1604, 255, 126, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("IronMine",
            new Position(-1035, 0, 389, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world")),
            new Position(-1285, 255, 88, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("LapisMine",
            new Position(-500, 0, -352, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world")),
            new Position(-937, 255, 46, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("RedstoneMine",
            ...
            new Position(-190, 255, 5, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("GoldMine",
            new Position(214, 0, 106, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world")),
            new Position(-233, 255, -348, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("DiamondMine",
            ...
            new Position(545, 255, 52, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        $this->addArea(new Area("EmeraldMine",
            ...
            new Position(1063, 255, 32, $this->emporiumPrison->getServer()->getWorldManager()->getWorldByName("world"))));
        /*
         * TODO
         *
         * Badlands
         * Events (koth prison break etc)
         */
    }
