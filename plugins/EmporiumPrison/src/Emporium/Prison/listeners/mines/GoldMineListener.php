        ...
        if($world == "world") {
            ...
            if($blockId === 14 || $blockId === 41) {
                if($itemId === 285) {
                    ...
                    if($energy >= $energyNeeded) {
                        if($pickaxeLevel >= 100) {
                            switch($blockId) {
                                ...
                                case BlockLegacyIds::GOLD_BLOCK: # (iron pickaxe required to break)
                                    if($playerLevel < 40) {
                                        $event->cancel();
                                        $player->sendMessage(Variables::SERVER_PREFIX . TF::RED . "Your player" . TF::GOLD . " /level" . TF::RED . " is too low!");
                                    } else {
                    ...
                    $event->cancel();
                    $player->sendMessage(Variables::SERVER_PREFIX . TF::GRAY . "Try using a " . TF::BOLD . TF::YELLOW . "Gold Pickaxe");
                }
            }
        }
    }
