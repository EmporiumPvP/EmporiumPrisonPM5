        ...
        if($pickaxeLevel == 100) {
            ...
            switch($blockId) {
                ...
                case BlockLegacyIds::IRON_ORE:
                    ...
                    # auto pickup
                    if($player->getInventory()->canAddItem(VanillaBlocks::IRON_ORE()->asItem())) {
                        $player->getInventory()->addItem(VanillaBlocks::IRON_ORE()->asItem());
                    } else {
                        $player->sendMessage(TF::RED . "Your inventory is full");
                        $player->getWorld()->dropItem($block->getPosition()->asVector3()->up(), VanillaBlocks::IRON_ORE()->asItem());
                    }
                    break;
                ...
                case BlockLegacyIds::IRON_BLOCK:
                    ...
                    # auto pickup (block)
                    if($player->getInventory()->canAddItem(VanillaBlocks::IRON()->asItem())) {
                        $player->getInventory()->addItem(VanillaBlocks::IRON()->asItem());
                    } else {
                        $player->sendMessage(TF::RED . "Your inventory is full");
                        $player->getWorld()->dropItem($block->getPosition()->asVector3()->up(), VanillaBlocks::IRON()->asItem());
                    }
                    break;
