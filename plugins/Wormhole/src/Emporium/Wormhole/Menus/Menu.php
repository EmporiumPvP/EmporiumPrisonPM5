...
namespace Emporium\Wormhole\Menus;
...
use Emporium\Wormhole\Core\Managers\RandomWormholeEnchant;
                        ...
                        case "efficiency":
                            if(is_numeric($level)) {
                                if($randomNumber <= $chance) {
                                    ...
                                    $pickaxeManager->addSuccessfulEnchant($item);
                                } else {
                                    $player->sendMessage(TF::RED . "Enchant Failed!");
                                    $pickaxeManager->addFailedEnchant($item);
                                }
                            } else {
