...
# Enchantment Class
class BackstabCE extends ReactiveEnchantment
{

    # Register Enchantment
    public string $name = "Backstab";
    public string $description = "Increases your damage while behind your opponent.";
    ...
    {
        if ($player->getDirectionVector()->dot($event->getEntity()->getDirectionVector()) > 0) {
            // Variables
