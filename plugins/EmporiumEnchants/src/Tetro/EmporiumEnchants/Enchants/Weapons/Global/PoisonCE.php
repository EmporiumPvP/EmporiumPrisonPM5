...
# Enchantment Class
class PoisonCE extends ReactiveEnchantment
{

    # Register Enchantment
    public string $name = "Poison";
    public string $description = "Inflict the enemy with poison.";
    ...
    public function react(Player $player, Item $item, Inventory $inventory, int $slot, Event $event, int $level, int $stack): void
    {
        ...
        // Enchantment Code
        $enemy = $event->getEntity();
        $enemy->getEffects()->add(new EffectInstance(VanillaEffects::POISON(), (20 * $level), $level - 1, false));
