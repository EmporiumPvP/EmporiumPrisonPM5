...
# Enchantment Class
class IceAspectCE extends ReactiveEnchantment
{

    # Register Enchantment
    public string $name = "Ice Aspect";
    public string $description = "Has a chance to inflict your opponent with slowness";
    ...
    public function react(Player $player, Item $item, Inventory $inventory, int $slot, Event $event, int $level, int $stack): void
    {
        ...
        $player->sendMessage("§l§b** IceAspect **");
