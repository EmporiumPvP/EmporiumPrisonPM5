...
# Enchantment Class
class CyberneticEnlightenedCE extends ReactiveEnchantment
{

    # Register Enchantment
    public string $name = "Cybernetic Enlightened";
    ...
    public function react(Player $player, Item $item, Inventory $inventory, int $slot, Event $event, int $level, int $stack): void
    {
        ...
        if ($event instanceof EntityDamageByEntityEvent) {
            ...
            if ($health <= 25) {
                ...
                $player->sendTitle(TextFormat::BOLD . TextFormat::LIGHT_PURPLE . "Cybernetic Enlightened", 20, 20, 20);
